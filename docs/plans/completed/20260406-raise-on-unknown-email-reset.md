...
- [x] Add a note to `CLAUDE.md` under Key conventions: `requestPasswordReset` now raises `UserNotFoundError` for unknown emails (email enumeration protection removed by product decision)
