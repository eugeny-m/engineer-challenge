...
- [x] write ADR-0001: GraphQL over gRPC/REST (browser compatibility, CQRS mapping)
- [x] write ADR-0002: Layered DDD over hexagonal (scope, complexity trade-off)
- [x] write ADR-0003: Python stack choice and alternatives considered
